...
- Changed factories to have `status` and `commissionedAt` to reflect the new client database changes (CU-86dv9rra0).

## [15.0.4] - 2024-10-29

### Changed

- Removed the 'DEVICE_' prefix from device_type enum (CU-86duvwbq2). 
...
- `gatewayDBFactory` now has default value for `id` (CU-86dthadwg).

## [15.0.1] - 2024-10-04

### Changed

- `gatewayDBFactory` now uses `createGateway` instead of `createDevice` (CU-86dthadwg).
...
- Session factories to use specific dates (CU-86791yyvg).
...
[unreleased]: https://github.com/bravetechnologycoop/brave-alert-lib/compare/v15.0.2...HEAD
[v15.0.2]: https://github.com/bravetechnologycoop/brave-alert-lib/compare/v15.0.1...v15.0.2
[v15.0.1]: https://github.com/bravetechnologycoop/brave-alert-lib/compare/v15.0.0...v15.0.1
[15.0.0]: https://github.com/bravetechnologycoop/brave-alert-lib/compare/v14.0.2...15.0.0
