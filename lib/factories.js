// factories.js
//
// This file provides factory functions to create database and JavaScript instances
// for various models. These are primarily used for unit and integration testing.

const ALERT_TYPE = require('./enums/alertTypeEnum')
const CHATBOT_STATE = require('./enums/chatbotStateEnum')
const DEVICE_TYPE = require('./enums/deviceTypeEnum')

const { Client, ClientExtension, Session, Device, Gateway, GatewaysVital, ButtonsVital, SensorsVital } = require('./models/index')
