...
async function clientDBFactory(db, overrides = {}) {
  const client = await db.createClient(
    ...
    overrides.status !== undefined ? overrides.status : STATUS.TESTING,
    overrides.commissionedAt !== undefined ? overrides.commissionedAt : null,
  )
...
function clientFactory(overrides = {}) {
  return new Client(
    ...
    overrides.commissionedAt !== undefined ? overrides.commissionedAt : '2024-03-29T19:23:48.154Z',
  )
}
